...
<div class="flex flex-col overflow-y-auto duration-300 ease-linear no-scrollbar">
    <nav class="mb-6">
        <ul class="flex flex-col gap-1">
            ...
            <!-- Menu Item: Dashboard (semua role) -->
            <li>
            ...
            {{-- Kalau ada menu Konfirmasi Member terpisah, sisipkan di sini juga dengan pola yang sama --}}
            ...
            {{-- Menu khusus Owner — Manajemen Admin --}}
            @if($isOwner)
            <li>
