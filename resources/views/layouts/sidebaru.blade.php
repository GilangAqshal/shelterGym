                ...
                @if(auth()->user()->role === 'user')
                    ...
                    <li>
                        <a href="{{ route('user.riwayat') }}"
                            class="menu-item group"
                            :class="[
                                {{ request()->routeIs('user.riwayat') ? 'true' : 'false' }} ? 'menu-item-active' : 'menu-item-inactive',
                                (!$store.sidebar.isExpanded && !$store.sidebar.isHovered && !$store.sidebar.isMobileOpen) ? 'xl:justify-center' : 'justify-start'
                            ]">
                            
                            <span class="{{ request()->routeIs('user.riwayat') ? 'menu-item-icon-active' : 'menu-item-icon-inactive' }}">
                                <svg width="24" height="24" fill="none" viewBox="0 0 24 24">
                                    <path stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"
