...
<!-- ================= NAVBAR ================= -->
<nav class="fixed top-0 w-full z-50 p-3 md:p-6 flex justify-center bg-transparent pointer-events-none">
    
    <div class="max-w-[1360px] w-full mx-auto px-4 py-2 md:px-6 md:py-4 flex justify-between items-center bg-white/80 backdrop-blur-xl rounded-full shadow-[0_15px_40px_-12px_rgba(37,99,235,0.15)] border border-white/60 pointer-events-auto">
        ...
        <div class="flex items-center gap-3">
            <a href="#home" class="flex items-center">
                <img src="/images/logo/logo.png"
                     alt="Logo"
                     class="h-7 md:h-11 w-auto object-contain drop-shadow-md">
            </a>
        </div>

        <!-- MENU DESKTOP -->
        <div class="hidden md:flex gap-7 font-medium items-center sg-desktop-menu text-gray-700">
            <a href="#home" class="text-blue-600 font-semibold hover:text-blue-700 transition duration-300">
                Home
            </a>
        ...
        <div class="flex items-center gap-2.5 md:gap-4">
            <a href="{{ route('login') }}"
               class="sg-glow-btn bg-gradient-to-r from-blue-600 to-cyan-500 text-white px-3.5 py-1.5 md:px-7 md:py-3 rounded-full text-xs md:text-base font-semibold shadow-md hover:scale-105 transition duration-300 whitespace-nowrap">
                <i class="fa-solid fa-right-to-bracket mr-1 md:mr-2 text-[10px] md:text-sm"></i>
                Masuk
            </a>

            <!-- MOBILE BUTTON (BURGER) -->
            <button id="sgMobileBtn"
                    class="sg-mobile-menu text-xl md:text-2xl text-blue-600 focus:outline-none p-1">
    ...
    <!-- MOBILE MENU -->
    <div id="sgMobileMenu"
         class="sg-mobile-dropdown fixed top-20 left-1/2 -translate-x-1/2 w-[92%] max-w-sm flex-col gap-5 px-8 py-8 bg-white/95 backdrop-blur-xl rounded-3xl shadow-xl border border-white/20 md:hidden pointer-events-auto">

        <a href="#home" class="hover:text-blue-600 font-medium transition duration-300">Home</a>
        <a href="#about" class="hover:text-blue-600 font-medium transition duration-300">About</a>
        <a href="#facilities" class="hover:text-blue-600 font-medium transition duration-300">Fasilitas</a>
        <a href="#pricing" class="hover:text-blue-600 font-medium transition duration-300">Pricing</a>
        <a href="#contact" class="hover:text-blue-600 font-medium transition duration-300">Contact</a>
    </div>
</nav>
    ...
    <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-16 relative z-10">
        ...
        <div class="flex-1">
            ...
            <p class="text-gray-600 mt-5 text-base md:text-lg leading-relaxed">
                Fasilitas lengkap, ada jadwal & gerakan latihan, dan komunitas fitness
...
<section id="facilities" class="py-28 bg-gray-50 px-6">
    <div class="max-w-7xl mx-auto text-center">
        ...
        <p class="mt-4 text-gray-600">
            Smual kebutuhan latihanmu tersedia lengkap di sini.
        </p>
        ...
        <div class="grid md:grid-cols-4 gap-8 mt-16">
            ...
            <div class="sg-modern-card bg-white rounded-3xl p-8 shadow-sm">
                ...
                <h3 class="font-bold text-xl mt-6">Area Panco</h3>
            ...
            <div class="sg-modern-card bg-white rounded-3xl p-8 shadow-sm">
                ...
                <h3 class="font-bold text-xl mt-6">Warung Sederhana</h3>
                <p class="text-sm text-gray-500 mt-3 leading-relaxed">
            ...
            <div class="sg-modern-card bg-white rounded-3xl p-8 shadow-sm">
                ...
                <h3 class="font-bold text-xl mt-6">Panduan Latihan</h3>
                <p class="text-sm text-gray-500 mt-3 leading-relaxed">
            ...
            <div class="sg-modern-card bg-white rounded-3xl p-8 shadow-sm">
                ...
                <h3 class="font-bold text-xl mt-6">Alat Lengkap</h3>
                <p class="text-sm text-gray-500 mt-3 leading-relaxed">
    ...
    <div class="max-w-7xl mx-auto text-center">
        ...
        <div class="grid md:grid-cols-3 gap-10">
            ...
            <div class="sg-modern-card border border-gray-200 rounded-[30px] p-10 bg-white">
                <h3 class="font-black text-2xl text-gray-700">1 BULAN</h3>
                <p class="text-5xl font-black my-8 text-blue-600">Rp125K</p>
            ...
            <div class="relative border-2 border-blue-600 rounded-[35px] p-10 bg-gradient-to-b from-blue-600 to-cyan-500 text-white shadow-2xl scale-105">
                ...
                <h3 class="font-black text-2xl">3 BULAN</h3>
                <p class="text-5xl font-black my-8">Rp300K</p>
            ...
            <!-- 6 BULAN -->
            <div class="sg-modern-card border border-gray-200 rounded-[30px] p-10 bg-white">
                <h3 class="font-black text-2xl text-gray-700">6 BULAN</h3>
                <p class="text-5xl font-black my-8 text-blue-600">Rp500K</p>
                <ul class="space-y-4 text-gray-500">
                    <li>✔ Akses Full Fasilitas</li>
...
<section id="contact" class="py-28 bg-gray-50 px-6 border-t">
    <div class="max-w-7xl mx-auto">
        <div class="text-center mb-16">
            ...
            <h2 class="text-5xl font-black mt-4">Hubungi Kami</h2>
            <p class="mt-4 text-gray-600">
        ...
        <div class="grid md:grid-cols-2 gap-10">
            ...
            <div class="bg-white rounded-[35px] p-8 shadow-lg">
                <div class="flex items-center gap-4 text-blue-600">
                    ...
                    <div>
                        <h3 class="font-black text-2xl text-gray-800">Lokasi Shelter Gym</h3>
                        <p class="text-gray-500 text-sm mt-1">Jatiasih, Bekasi</p>
                    </div>
                </div>

                <p class="text-gray-600 mt-6 leading-relaxed">
                    Jl. Raya Kodau, RT.003/RW.002, Jatimekar, Kec. Jatiasih, Kota Bekasi, Jawa Barat 17422
                </p>
            ...
            <div class="bg-white rounded-[35px] p-8 shadow-lg flex flex-col justify-between">
                <div>
                    <div class="flex items-center gap-4 text-blue-600">
                        ...
                        <div>
                            <h3 class="font-black text-2xl text-gray-800">Sosial Media</h3>
                            <p class="text-gray-500 text-sm mt-1">Tetap terhubung bersama kami</p>
                        </div>
                    </div>
                        ...
                        <a href="https://wa.me/628118843030"
                           ...
                           class="flex items-center justify-between p-5 rounded-2xl bg-emerald-50 hover:bg-emerald-100 transition duration-300 hover:scale-[1.02]">
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    <p class="font-bold text-emerald-700">WhatsApp</p>
                                    <p class="text-sm text-emerald-600">0811-8843-030</p>
                                </div>
                            </div>
                           ...
                           class="flex items-center justify-between p-5 rounded-2xl bg-pink-50 hover:bg-pink-100 transition duration-300 hover:scale-[1.02]">
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-pink-600">@sheltergymoffc</p>
                                </div>
                            </div>
                            <i class="fa-solid fa-arrow-right"></i>
                        </a>
                           ...
                           class="flex items-center justify-between p-5 rounded-2xl bg-gray-900 hover:bg-black transition duration-300 hover:scale-[1.02] text-white">
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-300">@shelter.gym</p>
                                </div>
                            </div>
                            <i class="fa-solid fa-arrow-right"></i>
                        </a>
                ...
                <div class="mt-10 bg-blue-50 rounded-2xl p-5">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-blue-600">Senin - Minggu • 24 Jam</p>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="relative -mb-1 overflow-hidden leading-none">
    <svg class="relative block w-full h-[80px] md:h-[120px] sg-wave-animation"
    ...
    <div class="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div class="grid md:grid-cols-4 gap-14 pb-16 border-b border-white/10 text-center md:text-left">
            ...
            <div class="flex flex-col items-center md:items-start">
                <img src="/images/logo/logo_dark.png" class="h-14" alt="Dark Logo">
                <p class="text-gray-400 mt-6 leading-relaxed max-w-xs">
                    Tempat fitness modern dengan fasilitas lengkap, trainer profesional, dan komunitas yang suportif.
                </p>
            ...
            <div>
                ...
                <div class="flex flex-col gap-4 text-gray-400">
                    <a href="#home" class="sg-footer-link">Home</a>
                    <a href="#about" class="sg-footer-link">About</a>
                    <a href="#facilities" class="sg-footer-link">Facilities</a>
                    <a href="#pricing" class="sg-footer-link">Pricing</a>
                    <a href="#contact" class="sg-footer-link">Contact</a>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="flex flex-col gap-4 text-gray-400">
                    <p class="sg-footer-link cursor-pointer">Arena Panco</p>
                    <p class="sg-footer-link cursor-pointer">Fitness Exercises</p>
                    <p class="sg-footer-link cursor-pointer">Weight Machine</p>
                    <p class="sg-footer-link cursor-pointer">Cardio Machine</p>
                    <p class="sg-footer-link cursor-pointer">Free Weight</p>
                </div>
            </div>
            ...
            <div class="flex flex-col items-center md:items-start">
                ...
                <div class="mt-6 flex flex-col gap-4 w-full max-w-sm">
                    ...
                    <a href="{{ route('login') }}"
                       class="bg-gradient-to-r from-blue-600 to-cyan-500 py-4 rounded-2xl font-bold hover:scale-[1.02] transition text-center block">
                        Subscribe Sekarang
                    </a>
                </div>
            </div>
...
<script>
    const mobileBtn = document.getElementById('sgMobileBtn');
    ...
    mobileBtn.addEventListener('click', (e) => {
        ...
        // Ubah icon burger menjadi ikon silang (X) saat aktif
    ...
    // Tutup menu jika pengguna mengklik di luar area menu/tombol navbar
